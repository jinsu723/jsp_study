...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/admin/adminParty.css">
...
<body>
  ...
  <script defer src="${pageContext.request.contextPath}/assets/js/admin/adminParty.js"></script>
</body>
