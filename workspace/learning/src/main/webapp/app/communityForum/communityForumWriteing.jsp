...
<body>
	...
	<div class="container">
		<!-- 작성완료 경로 처리하기 -->
		<form id="write-form"
			action="${pageContext.request.contextPath}/app/communityForum/communityForumWritingAdd.cf"
  ...
  <main class="communityForumWriting-main">
    <div class="communityForumWriting-main-container">
      ...
      <div class="communityForumWriting-content">
        ...
        <p id="communityForumWriting-content-text-content" contentEditable="true" placeholder="내용을 입력해 주세요."></p>
      </div>
